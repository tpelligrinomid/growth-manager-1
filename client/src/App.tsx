            ...
            <div className="metrics-container">
              ...
              <div className="metric-card">
                ...
                <div className="metric-value">
                  ${filteredAccounts.reduce((sum, account) => sum + (account.mrr || 0), 0).toLocaleString()}
                </div>
              </div>
              ...
              <div className="metric-card">
                ...
                <div className="metric-value">
                  ${filteredAccounts.length > 0 ? Math.round(filteredAccounts.reduce((sum, account) => sum + (account.mrr || 0), 0) / filteredAccounts.length).toLocaleString() : '0'}
                </div>
              </div>
